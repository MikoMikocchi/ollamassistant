  ...
  messages.push({
    ...
    content:
      ...
      [
        ...
        "Если в сообщении пользователя есть раздел 'Контекст:', сначала сделай краткое резюме контекста (введение + 5–8 пунктов), затем при необходимости ответь на вопрос.",
        "Сохраняй Markdown-разметку: заголовки, списки, код (```), таблицы.",
        "Избегай выдумок; если данных не хватает — запроси уточнение.",
      ].join(" \n"),
  });
